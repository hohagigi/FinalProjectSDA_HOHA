...
//// pentru pred CatBoosts
  if($row['FTR']==0 && $row['predCB']==0)          $preciziac[0]++; //cea corecta
  if($row['FTR']==1 && $row['predCB']==0)          $preciziac[1]++;
  if($row['FTR']==2 && $row['predCB']==0)          $preciziac[2]++;
    
  if($row['FTR']==0 && $row['predCB']==1)          $preciziac[3]++; 
  if($row['FTR']==1 && $row['predCB']==1)          $preciziac[4]++;  //cea corecta
  if($row['FTR']==2 && $row['predCB']==1)          $preciziac[5]++;

  if($row['FTR']==0 && $row['predCB']==2)          $preciziac[6]++; 
  if($row['FTR']==1 && $row['predCB']==2)          $preciziac[7]++;  
  if($row['FTR']==2 && $row['predCB']==2)          $preciziac[8]++;//cea corecta
...
$query="select * from  games, temp_stats where games.id=temp_stats.id_games and  status='complete' and 
      dataj>='".$data_inceput."' and dataj <='".$data_sfarsit." 23:59' ";
if ($castigator>=0 && $castigator<=2)
    $query=$query." and ".$tip_pred."=".$castigator;
...
$query=$query." order by dataj desc";
...
print "<td class='" . $class . "'>Goluti<br>marcate<br>Home<br>Team</td>";
print "<td class='" . $class . "'>Goluri<br>primite<br>Home<br>Team</td>";
print "<td class='" . $class . "'>Goluri<br>marcate<br>away<br>team</td>";
print "<td class='" . $class . "'>Goluri<br>primite<br>away<br>team</td>";
...
print "<td class='" . $class . "'>Pred NN</td>";
print "<td class='" . $class . "'>Pred DT</td>";
print "<td class='" . $class . "'>Pred CB</td>";
...
if($row['FTHG']<$row['FTAG'])
  ...
  //evit impartirea la 0 cu primul if
  if($row['precizia0']+$row['precizia1']+$row['precizia2'] == 0)                $prec1 = 0;
  else     $prec1 = $row['precizia0']/($row['precizia0']+$row['precizia1']+$row['precizia2']);
  if($row['precizia3']+$row['precizia4']+$row['precizia5'] == 0)                $precx = 0;
  else     $precx = $row['precizia4']/($row['precizia3']+$row['precizia4']+$row['precizia5']);
  if($row['precizia6']+$row['precizia7']+$row['precizia8'] == 0)                $prec2 = 0;
  else     $prec2 = $row['precizia8']/($row['precizia6']+$row['precizia7']+$row['precizia8']);

  if($row['preciziaa0']+$row['preciziaa1']+$row['preciziaa2'] == 0)                $preca1 = 0;
  else     $preca1 = $row['preciziaa0']/($row['preciziaa0']+$row['preciziaa1']+$row['preciziaa2']);
  if($row['preciziaa3']+$row['preciziaa4']+$row['preciziaa5'] == 0)                $precax = 0;
  else     $precax = $row['preciziaa4']/($row['preciziaa3']+$row['preciziaa4']+$row['preciziaa5']);
  if($row['preciziaa6']+$row['preciziaa7']+$row['preciziaa8'] == 0)                $preca2 = 0;
  else     $preca2 = $row['preciziaa8']/($row['preciziaa6']+$row['preciziaa7']+$row['preciziaa8']);

  if($row['preciziab0']+$row['preciziab1']+$row['preciziab2'] == 0)                $precb1 = 0;
  else     $precb1 = $row['preciziab0']/($row['preciziab0']+$row['preciziab1']+$row['preciziab2']);
  if($row['preciziab3']+$row['preciziab4']+$row['preciziab5'] == 0)                $precbx = 0;
  else     $precbx = $row['preciziab4']/($row['preciziab3']+$row['preciziab4']+$row['preciziab5']);
  if($row['preciziab6']+$row['preciziab7']+$row['preciziab8'] == 0)                $preca2 = 0;
  else     $precb2 = $row['preciziab8']/($row['preciziab6']+$row['preciziab7']+$row['preciziab8']);
  
  if($row['preciziac0']+$row['preciziac1']+$row['preciziac2'] == 0)                $precc1 = 0;
  else     $precc1 = $row['preciziac0']/($row['preciziac0']+$row['preciziac1']+$row['preciziac2']);
  if($row['preciziac3']+$row['preciziac4']+$row['preciziac5'] == 0)                $preccx = 0;
  else     $preccx = $row['preciziac4']/($row['preciziac3']+$row['preciziac4']+$row['preciziac5']);
  if($row['preciziac6']+$row['preciziac7']+$row['preciziac8'] == 0)                $precc2 = 0;
  else     $precc2 = $row['preciziac8']/($row['preciziac6']+$row['preciziac7']+$row['preciziac8']);
  
//   if($row['pred1']==0)
//     {
//     print "<td class='tdClass0'>" . $row['pred1'] ."(".round($prec1,3).")</td>"; 
//     //  print "<td class='tdClass0'>" . $row['pred1'] ."</td>";
//     //  print "<td class='tdClass0'>" .round($prec1,2)."</td>";
...
//  if($row['pred1']==1)
//     {
//   print "<td class='tdClass1'>" . $row['pred1'] ."(".round($precx,3).")</td>"; 
//     //  print "<td class='tdClass1'>" . $row['pred1'] . "</td>";
//     //     print "<td class='tdClass1'>" .round($precx,2)."</td>"; 
...
//   if($row['pred1']==2)
//     {
//     print "<td class='tdClass2'>" . $row['pred1'] ."(".round($prec2,3).")</td>"; 
//     //    print "<td class='tdClass2'>" . $row['pred1']."</td>";
//     //     print "<td class='tdClass2'>" .round($prec2,2)."</td>";  
...
//     }
  ...
  if($row['pred2']==-1)
    { 
    print "<td class='tdClass_1'>&nbsp;</td>"; 
    //  print "<td class='tdClass0'>" . $row['predNN'] . "</td>";
    //  print "<td class='tdClass0'>" .round($preca1,2)."</td>"; 
    // print "<td class='tdClass0'>" . $row['predNN_1'] . "</td>";
    // print "<td class='tdClass0'>" . $row['predNN_x'] . "</td>";
    // print "<td class='tdClass0' align='center'>" . $row['predNN_2'] . "</td>";
    }
  if($row['pred2']==0)
    { 
    print "<td class='tdClass0'>" . $row['pred2'] ."(".round($preca1,3).")</td>"; 
    //  print "<td class='tdClass0'>" . $row['predNN'] . "</td>";
    //  print "<td class='tdClass0'>" .round($preca1,2)."</td>"; 
    // print "<td class='tdClass0'>" . $row['predNN_1'] . "</td>";
    // print "<td class='tdClass0'>" . $row['predNN_x'] . "</td>";
 ...
 if($row['pred2']==1)
    {
    print "<td class='tdClass1'>" . $row['pred2'] ."(".round($precax,3).")</td>";   
    //  print "<td class='tdClass1'>" . $row['predNN']."</td>";
    //   print "<td class='tdClass1'>" .round($precax,2)."</td>";
    // print "<td class='tdClass1'>" . $row['predNN_1'] . "</td>";
    // print "<td class='tdClass1'>" . $row['predNN_x'] . "</td>";
    // print "<td class='tdClass1' align='center'>" . $row['predNN_2'] . "</td>";
    }
  if($row['pred2']==2)
    {
    print "<td class='tdClass2'>" . $row['pred2'] ."(".round($preca2,3).")</td>";        
    //  print "<td class='tdClass2'>" . $row['predNN'] ."</td>";
    // print "<td class='tdClass2'>" .round($preca2,3)."</td>"; 
    // print "<td class='tdClass2'>" . $row['predNN_1'] . "</td>";
    // print "<td class='tdClass2'>" . $row['predNN_x'] . "</td>";
    // print "<td class='tdClass2' align='center'>" . $row['predNN_2'] . "</td>";
    }      
  if($row['predDT']==0)
    { 
    print "<td class='tdClass0'>" . $row['predDT'] ."(".round($precb1,5).")</td>"; 
    //  print "<td class='tdClass0'>" . $row['predNN'] . "</td>";
    //  print "<td class='tdClass0'>" .round($preca1,2)."</td>"; 
    // print "<td class='tdClass0'>" . $row['predNN_1'] . "</td>";
    // print "<td class='tdClass0'>" . $row['predNN_x'] . "</td>";
 ...
 if($row['predDT']==1)
    {
    print "<td class='tdClass1'>" . $row['predDT'] ."(".round($precbx,5).")</td>";   
    }
  if($row['predDT']==2)
    {
    print "<td class='tdClass2'>" . $row['predDT'] ."(".round($precb2,5).")</td>";        
    } 
  if($row['predDT']==-1)
    {
    print "<td class='tdClass_1'>&nbsp;</td>";        
  ...
  if($row['predCB']==0)
    { 
    print "<td class='tdClass0'>" . $row['predCB'] ."(".round($precc1,3).")</td>"; 
    }
 if($row['predCB']==1)
    {
    print "<td class='tdClass1'>" . $row['predCB'] ."(".round($preccx,3).")</td>";   
    }
  if($row['predCB']==2)
    {
    print "<td class='tdClass2'>" . $row['predCB'] ."(".round($precc2,3).")</td>";        
    }    
if($row['predCB']==-1)
    {
    print "<td class='tdClass_1'>&nbsp;</td>";        
